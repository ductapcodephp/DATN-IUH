...
export default function Login() {
    ...
    return (
        <div className="yeti-login-page-wrapper">
            ...
            <form onSubmit={submit}>
                {(errors.system || pageErrors.system) && (
                    <div style={{ color: '#721c24', backgroundColor: '#f8d7da', padding: '10px', borderRadius: '5px', marginBottom: '15px', fontSize: '13px', textAlign: 'center' }}>
                        {errors.system || pageErrors.system}
                    </div>
                )}
                ...
                <div className="inputGroup inputGroup1">
                    ...
                    />
                    {errors.email ? (
                        <p className="helper" style={{ color: '#ef4444' }}>{errors.email}</p>
                    ) : (
                ...
                <div className="inputGroup inputGroup2">
                    ...
                    <input
                        ...
                        required
                    />
                    {errors.password && <p className="helper" style={{ color: '#ef4444' }}>{errors.password}</p>}
                ...
                <div style={{ display: 'flex', alignItems: 'center', margin: '0 0 20px 0', padding: '0 5%' }}>
                    <input
                        id="remember_me"
                        type="checkbox"
                        checked={data.remember}
                        onChange={(e) => setData('remember', e.target.checked)}
                        style={{ width: 'auto', margin: '0 10px 0 0', cursor: 'pointer' }}
                    />
                    <label htmlFor="remember_me" style={{ color: '#3A5E77', fontSize: '14px', cursor: 'pointer', position: 'static', transform: 'none' }}>
                        Ghi nhớ đăng nhập
                    </label>
                </div>

                <div className="inputGroup inputGroup3">
                    <button id="login" type="submit" disabled={processing}>
                ...
                <div className="social-login-container">
                    ...
                    <div className="social-buttons">
                        <button type="button" className="btn-social btn-google" onClick={() => window.location.href = route('auth.google')}>
                        ...
                        <button type="button" className="btn-social btn-facebook" onClick={() => console.log('Facebook Login Clicked')}>
                            <svg viewBox="0 0 24 24" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
