...
export default function Create({ categories = [] }) {
    ...
    return (
        <CMSLayout>
            <Head title="Tạo Bài Viết Mới - CMS" />
            
            <form onSubmit={handleSubmit}>
                <div className="d-flex justify-content-between align-items-center mb-5">
                    <div>
                        <h2 className="wow-title mb-1">Tạo Bài Viết Mới</h2>
                        <p className="m-0" style={{ color: 'var(--wow-text-muted)' }}>Thiết lập nội dung bài viết và xuất bản</p>
                    </div>
