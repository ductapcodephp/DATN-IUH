                            ...
                            <form onSubmit={(e) => e.preventDefault()}>
                                <div className="row g-3">
                                    <div className="col-md-6">
                                        ...
                                        <input type="text" id="contactName" className="form-control-custom orange-input-focus" placeholder="Ví dụ: Nguyễn Văn A" required />
                                    </div>
                                    
                                    <div className="col-md-6">
                                        <label htmlFor="contactEmail" className="form-label font-sm fw-semibold text-dark">Địa chỉ Email *</label>
                                        <input type="email" id="contactEmail" className="form-control-custom orange-input-focus" placeholder="name@example.com" required />
                                    </div>

                                    <div className="col-md-12">
                                        <label htmlFor="contactPhone" className="form-label font-sm fw-semibold text-dark">Số điện thoại *</label>
                                        <input type="tel" id="contactPhone" className="form-control-custom orange-input-focus" placeholder="Ví dụ: 0912345678" required />
                                    </div>

                                    <div className="col-md-12">
                                        <label htmlFor="contactSubject" className="form-label font-sm fw-semibold text-dark">Chủ đề cần hỗ trợ</label>
                                        <input type="text" id="contactSubject" className="form-control-custom orange-input-focus" placeholder="Tư vấn khóa học / Báo lỗi / Hợp tác..." />
                                    </div>

                                    <div className="col-md-12">
                                        <label htmlFor="contactMessage" className="form-label font-sm fw-semibold text-dark">Nội dung tin nhắn *</label>
                                        <textarea id="contactMessage" className="form-control-custom orange-input-focus" rows="5" placeholder="Nhập nội dung bạn cần chúng tôi hỗ trợ tại đây..." required></textarea>
                                    </div>

                                    <div className="col-md-12 pt-2">
                                        <button type="submit" className="btn btn-dark w-100 py-3 fw-semibold btn-gradient-orange" style={{ borderRadius: "6px" }}>Gửi thông tin liên hệ</button>
                                    </div>
                                </div>
                            </form>
                        </div>
