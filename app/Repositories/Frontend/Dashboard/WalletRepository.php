...
class WalletRepository implements WalletRepositoryInterface
{
    public function getWalletInfo(int $userId): ?array
    {
        ...
        $totalSpent = WalletTransaction::where('user_id', $userId)->where('type', WalletTransaction::TYPE_PURCHASE)->where('status', WalletTransaction::STATUS_COMPLETED)->sum('amount');
        return [
            'id' => $wallet->id, 'balance' => (float) $wallet->balance,
            'total_deposited' => (float) $totalDeposited, 'total_spent' => (float) $totalSpent,
